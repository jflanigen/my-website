...
function ExperiencePage(){
    ...
    <div className="flex flex-col items-center text-center justify-center min-h-screen">
        ...
        <div className="bg-gray-700 text-gray-200 p-8 rounded shadow-2xl shadow-fuchsia-600/90 w-11/12 mt-16 mb-16">
            ...
            <p className="text-2xl my-4">While I don't have industry level experience, here are a couple jobs I've worked:</p>
            <h2 className="underline text-3xl decoration-4 underline-offset-8 font-medium decoration-fuchsia-600 my-8">Valet Attendant @ 425 Fitness</h2>
            ...
            <h2 className="underline text-3xl decoration-4 underline-offset-8 font-medium decoration-fuchsia-600 my-8">Head Youth Ref and Instructor @ i9 Sports</h2>
            ...
            <h1 className="underline text-5xl decoration-4 underline-offset-8 font-medium decoration-fuchsia-600 my-8 mt-16 mb-12">- University Experience -</h1>
            ...
            <p className="text-2xl my-4 mx-64">Grade received: <span className="text-fuchsia-600">B-</span> (oops)</p>
