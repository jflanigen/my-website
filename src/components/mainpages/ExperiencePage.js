...
function ExperiencePage(){
    ...
    <div className="flex flex-col items-center text-center justify-center min-h-screen">
        ...
        <div className="bg-gray-700 text-gray-200 p-8 rounded shadow-2xl shadow-fuchsia-600/90 w-11/12 mt-16 mb-16">
            ...
            <p className="text-2xl my-4 mx-24 lg:mx-64">While I don't have industry level experience in software development, here are a couple jobs I've worked:</p>
            ...
            <p className="text-2xl my-4 mx-24 lg:mx-64">Introduction to computer systems that exhibit intelligent behavior, in particular, perceptual and robotic systems. Topics include human computer interfaces, computer vision, robotics, game playing, pattern recognition, knowledge representation, planning.</p>
            <p className="text-2xl my-4 mx-24">Grade received: <span className="text-fuchsia-600">A</span></p>
            ...
            <p className="text-2xl my-4 mx-24 lg:mx-64">Concepts involved in the design of programming languages. Bindings, argument transmission, and control structures. Environments: compile-time, load-time, and run-time. Interpreters.</p>
            <p className="text-2xl my-4 mx-24">Grade received: <span className="text-fuchsia-600">B+</span></p>
            ...
            <p className="text-2xl my-4 mx-24 lg:mx-64">Basic concepts, data structures, and algorithms for geometric objects. Examples of topics: Cartesian geometry, transformations and their representation, queries and sampling, triangulations. Emphasis on rigorous reasoning and analysis, advancing algorithmic maturity and expertise in its application.</p>
            <p className="text-2xl my-4 mx-24">Grade received: <span className="text-fuchsia-600">B+</span></p>
            ...
            <p className="text-2xl my-4 mx-24 lg:mx-64">Covers advanced programming techniques and data structures. Topics include recursion, algorithm analysis, linked lists, stacks, queues, trees, graphs, tables, searching, and sorting.</p>
            <p className="text-2xl my-4 mx-24">Grade received: <span className="text-fuchsia-600">B+</span></p>
            ...
            <p className="text-2xl my-4 mx-24 lg:mx-64">The first course for computer science majors and anyone seeking a rigorous introduction. Develops computational problem-solving skills by programming in the Python language, and exposes students to variety of other topics from computer science and its applications.</p>
            <p className="text-2xl my-4 mx-24">Grade received: <span className="text-fuchsia-600">B+</span></p>
            ...
            <p className="text-2xl my-4 mx-24 lg:mx-64">Representation, analysis, techniques, and principles for manipulation of basic combinatoric structures used in computer science. Rigorous reasoning is emphasized.</p>
            <p className="text-2xl my-4 mx-24">Grade received: <span className="text-fuchsia-600">B-</span></p>
        </div>
    </div>
    </>
