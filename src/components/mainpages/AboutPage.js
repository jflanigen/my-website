...
function AboutPage(){
    ...
    function ButtonToHomePage(){
        ...
        return (
            <>
                <button onClick={clickButton} className="transition ease-in-out duration-300 hover:scale-110 mt-16 bg-teal-500 text-gray-200 text-2xl p-4 rounded shadow-2xl shadow-teal-500/60 my-4 
